export interface EngineeringManual {
  title: string;
  purpose: string;
  inputs: [string, string, string][];
  calculations: [string, string, string][];
  trends: string[];
  limits: string[];
  sources: [string, string][];
}

export const engineeringManuals: Record<string, EngineeringManual> = {
  "air-blower": {
    title: "Air Blower",
    purpose:
    ...
    inputs: [
      [
        "Timestamp; motor current for each train",
        "date/time; A",
        "Select the running train and calculate power.",
      ],
      [
        "Suction / discharge pressure for each train",
        "kPaa / kPag",
        "Calculate absolute pressure ratio and pressure rise.",
      ],
      [
        "Total air flow; suction and discharge gas temperature",
        "Nm³/h; °C",
        "Flow comparison and thermodynamic efficiency. Both temperatures are needed.",
      ],
      [
        "Vibration; bearing temperature for each train",
        "mm/s RMS; °C",
        "Condition alerts and recent trends.",
      ],
      [
        "Bypass opening; filter differential pressure; pressure setpoint",
        "% open; bar; kPag",
        "Operating conditions and baseline eligibility.",
      ],
      [
        "Voltage, power-factor method, k, atmosphere, limits",
        "Configuration",
        "Use values for the installed machine.",
      ],
    ],
    calculations: [
      [
        "Pressure",
        "P₁ = suction / 100; P₂ = discharge / 100 + Pₐₜₘ; r = P₂ / P₁",
      ...
      [
        ...
        "Index power = Qₙ × ΔP / 36; index = 100 × index power / Pₑ",
    ...
    sources: [
      ...
      [
        "ISO 20816-3: vibration evaluation scope",
  ...
  "fired-heater": {
    ...
    inputs: [
      [
        "Timestamp; fuel mass flow",
        "date/time; kg/s",
        "Fuel heat input and trends.",
      ],
      [
        "Fuel composition and LHV",
        "Mole fractions; MJ/kg",
        "Select a saved fuel or enter a custom blend in Configuration.",
      ],
      [
        "Fuel, combustion-air and stack temperature",
        "°C",
        "Sensible heat and stack loss.",
      ],
      [
        "Stack oxygen",
        "vol% wet",
        "Combustion-air balance, matching the supplied heater example.",
      ],
      [
        "Process flow, heat capacity and inlet/outlet temperature",
        "kg/s; kJ/(kg·K); °C",
        "Optional independent process-side duty.",
      ],
      [
        "Bridgewall temperatures",
        "°C",
        "Average available readings and compare with configured limits.",
      ],
      [
        "Reference temperature, radiation loss and design duty",
        "°C; %; kW",
    ...
    calculations: [
      ...
      [
        "Heat balance",
        "Qabsorbed = ṁfuel × LHV + Qfuel,sensible + Qair,sensible − Qstack − Qradiation",
        "kW with LHV in kJ/kg. Each sensible term is ṁCp(T − Treference). Radiation is a configured fraction of fuel LHV input.",
      ],
      [
        "Efficiency",
        "ηbalance = 100 × Qabsorbed / QLHV; Qprocess = ṁprocess Cp ΔT",
        "Process efficiency = 100 × Qprocess / QLHV. Closure = 100 × |Qabsorbed − Qprocess| / QLHV.",
      ],
      [
        "Loss estimate",
        "ηloss = 100 − dry-gas loss − moisture loss − radiation loss − unaccounted loss",
    ...
    sources: [
      ...
      [
        "ASME PTC 4: fired steam-generator test framework, not certification of this simplified calculation",
        "https://www.asme.org/codes-standards/find-codes-standards/fired-steam-generators/2013/pdf",
      ],
    ],
  },
  "shell-tube-exchanger": {
    ...
    inputs: [
      [
        "Timestamp; hot and cold inlet/outlet temperatures",
        "date/time; °C",
        "Four temperatures for duty and temperature driving force.",
      ],
      [
        "Hot and cold mass flow and heat capacity",
        "kg/h; kJ/(kg·K)",
        "Both stream duties and heat-capacity rates.",
      ],
      [
        "Shell and tube differential pressure",
        "bar",
        "Optional measured pressure drops; retained in results.",
      ],
      [
        "Shell passes, heat-transfer area, clean U and design duty",
        "count; m²; W/(m²·K); MW",
        "Configuration for correction factor and reference comparisons.",
      ],
    ],
    calculations: [
      [
        "Duty",
        "Qhot = ṁhot Cp,hot(Th,in − Th,out)/3600; Qcold = ṁcold Cp,cold(Tc,out − Tc,in)/3600",
      ...
      [
        ...
        "U = 1000 × Qavg / (A × F × LMTD); Rf = 1/U − 1/Uclean",
        "Rf is displayed in 10⁻⁴ m²·K/W. Negative values mean performance exceeds the chosen clean reference.",
      ],
      [
        "Effectiveness and design comparison",
        "ε = 100 × Qavg / [Cmin(Th,in − Tc,in)]",
  ...
  "membrane-analyzer": {
    title: "Hydrogen Membrane",
    purpose:
      "Track hydrogen recovery, permeate purity, feed pressure and the feed-to-non-permeate flow ratio.",
    inputs: [
      [
        "Timestamp; feed and permeate flow",
        "date/time; Nm³/h",
        "Hydrogen recovery and flow balance.",
      ],
      [
        "Non-permeate flow",
        "Nm³/h",
        "Flow ratio; derived as feed minus permeate if absent.",
      ],
      [
        "Feed and permeate H₂ content",
        "vol%",
        "Separate online analyzer and laboratory readings.",
      ],
      ["Feed pressure", "kPag", "Compare with the design pressure."],
      [
        "Design values and condition limits",
        "Configuration",
        "Recovery, purity, flow ratio and pressure references.",
      ],
    ],
    calculations: [
      [
        "Hydrogen recovery",
        "Recovery = 100 × (Qpermeate × yH₂,permeate) / (Qfeed × yH₂,feed)",
        "Online and lab cases use their respective compositions. All flows must share the same reference conditions.",
      ],
      [
        "Purity and flow ratio",
        "Purity = permeate H₂%; ratio = Qfeed / Qnon-permeate",
        "Purity is an input measurement, not a predicted membrane composition.",
      ],
      [
        "Pressure deviation",
        "Deviation = 100 × (Pfeed − Pdesign) / Pdesign",
  ...
  "furnace-skin-temp": {
    title: "Furnace Skin Temperature",
    purpose:
    ...
    inputs: [
      [
        "Timestamp and each mapped skin thermocouple",
        "date/time; °C",
        "Current maximum and recent temperature trend for each pass.",
      ],
      [
        "Available pass flows and process drivers",
        "Units defined in the supplied model bundle",
        "Model features and the Pass 3 flow-split scenario.",
      ],
      [
        "Furnace/pass mapping, sampling interval and trained models",
        "Published model bundle",
        "Defines available thermocouples, feature names and validation results.",
      ],
    ],
    calculations: [
      [
        "Temperature trajectory",
        "T(d) = Tnow + recent slope × d",
      ...
      [
        "Uncertainty display",
        "Trained-horizon P10, P50 and P90 = base score + sum of tree outputs",
      ...
      [
        "Pass maximum and crossing",
        "Tpass(d) = max(Tthermocouples(d))",
      ...
      [
        "Current status",
        "Alarm: T ≥ 470 °C or crossing < 24 h; advisory: T ≥ 460 °C or crossing < 72 h",
        "These are review thresholds. The requested forecast target remains 475 °C.",
      ],
      [
        "Flow-split scenario",
        "Pass 3 split = 100 × Q₃ / ΣQpass",
  ...
  "crude-to-profit": {
    ...
    inputs: [
      ...
      [
        "Residue technology",
        "None / LC Finer / Delayed Coker",
        "Treat vacuum residue or retain it unpriced.",
      ],
      [
        "Gas-oil technology",
        "None / Hydrocracker / FCC",
        "Treat straight-run and eligible converted gas oils once.",
      ],
      [
        "Price case",
        "Low / High / Live market",
        "C$/m³ feed and product prices; dated sources appear in Price snapshot.",
      ],
      [
        "Yields, densities, cut points and coker carbon residue",
        "Stored assumptions",
        "Convert feeds into product volumes; assumptions are not live plant measurements.",
      ],
    ],
    calculations: [
      [
        "Primary split",
        "Cut flow = crude flow × volume yield / 100",
        "Calculate blend shares, barrel flow and sulfur mass. VGO is the sum of its light, medium and heavy cuts.",
      ],
      [
        "Residue conversion",
        "Product mass = residue mass × weight yield / 100; volume = mass / density",
        "LC Finer uses the workbook split. Delayed coking uses feed carbon residue (CCR).",
      ],
      [
        "Delayed coker",
        "Gas = 7.80 + 0.144CCR; naphtha = 11.29 + 0.343CCR; coke = 1.60CCR",
        "wt%. Gas oil is the remainder to 100%; it remains one pool rather than invented diesel/VGO subcuts.",
      ],
      [
        "Gas-oil conversion",
        "Pool = straight-run VGO + converted gas oil + heavy light-stream tails",
      ...
      [
        "Operating costs",
        "Annual OPEX = annual sales revenue × OPEX percentage / 100",
      ...
      [
        ...
        "Annual margin after OPEX = annual sales − annual crude purchases − annual configured OPEX",
    ...
    sources: [
      [
        "Suncor 2025: R&M operating, selling and general expenses CAD 2,439 million / operating revenue CAD 30,671 million = 7.95%, rounded to an 8% planning allowance. Includes marketing/general costs; not a technology-specific utility estimate.",
      ...
      [
        "Grace: Strategies for Maximizing FCC Light Cycle Oil, Table 1, printed p.48",
        "https://grace.com/content/dam/grace-site/english/grace-publications/Grace-The-Essential-Articles-Vol-1_WEB.pdf#page=49",
      ],
