...
export const EQUIPMENT_REGISTRY: EquipmentRegistryEntry[] = [
  { id: "air-blower", name: "Air Blower", tag: "C-101A/B", path: "/equipment/air-blower", state: "watch" },
  { id: "fired-heater", name: "Fired Heater", tag: "H-401", path: "/equipment/fired-heater", state: "normal" },
  { id: "shell-tube-exchanger", name: "Shell & Tube Exchanger", tag: "E-201", path: "/equipment/shell-tube-exchanger", state: "watch" },
  { id: "membrane-analyzer", name: "Membrane Analyzer", tag: "M-301", path: "/equipment/membrane-analyzer", state: "watch" },
  { id: "furnace-skin-temp", name: "Furnace Skin TI Predictor", tag: "Heater 2 / Pass 2", path: "/predictors/furnace-skin-temp", state: "normal" },
];
