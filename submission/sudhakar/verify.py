...
if __name__=='__main__':
    ...
    rows=['# Python verification report','','Executed from the standalone submission folder. All tests passed.','',f'Python {platform.python_version()}; {result.testsRun} test methods, {len(cases)} production-TypeScript comparison cases and six command-line examples plus six isolated single-file runs.','', '| Model | Identical-input cases | Result |','|---|---:|---|']
